// @ts-check
// Testing And Playing Music Audio and controlling it
...
// Uncomment the one you want to hear

// loadMusic("bgmusic", "/examples/sounds/OtherworldlyFoe.mp3");
loadMusic("bgmusic", "/examples/sounds/theelevatorbossanova.mp3");
// loadMusic("bgmusic", "/examples/sounds/ducksong.mp3");
